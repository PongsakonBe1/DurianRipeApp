...
title = DurianRipeClassify

# (str) Package name
package.name = durianripeapp
...
source.include_patterns = assets/fonts/*.ttf, assets/models/*.tflite, assets/**
...
requirements = python3,kivy,numpy,pyjnius,android,tflite-runtime
...
android.add_assets = assets/fonts:fonts, assets/models:models
...
p4a.extra_args = --copy-libs --allow-minsdk-ndkapi-mismatch
